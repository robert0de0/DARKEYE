#!/bin/bash
# DARKEYE v1.0 is an upgrade from original ShellPhish Tool (https://github.com) by RedKnight
# Coded by: @RedKnight
# Upgraded by: @Robert_Kunga
...
printf "     \e[101m\e[1;77m:: responsible for any misuse or damage caused by DARKEYE.  ::\e[0m\n"
printf "     \e[101m\e[1;77m:: Only use for educational purporses!!                      ::\e[0m\n"
printf "\n"
printf "     \e[101m\e[1;77m::     DARKEYE v1.5! By @Robert_Kunga & @RedKnight     ::\e[0m\n"
printf "\n"
}
